...
class Inventaire extends DynamicTable{
    ...
    public function add($idItem) {
        return $this->db->call("add_inventaire",
        [
            "idItem" => $idItem,
    ...
    public function get($idItem) {
        $record = $this->db->selectWhere("inventaire", [
            ["idItem", "=", $idItem], 
            ["idJoueur", "=", $this->idJoueur]
        ]);
    ...
    public function update($idItem, $quantity = null) {
        return $this->db->call("update_inventaire",
        [
            "idJoueur" => $this->idJoueur,
            "idItem" => $idItem,
            "quantity" => $quantity
    ...
    public function remove($idItem) {
        return $this->db->call("remove_inventaire",
        [
            "idJoueur" => $this->idJoueur,
            "idItem" => $idItem
        ]);
    ...
    public function toList() {
        $list = [];
        $records = $this->db->selectWhere("inventaire", [["idJoueur", "=", $this->idJoueur]]);
